...
export type TextColor = 'primary' | 'secondary' | 'light' | 'dark' | 'disabled'| 'default' ;

export type TextStylesProp = {
  [x in TextType]: StyleProp<TextStyle>;
}

export type TypographyMakeStyles = {
  type?: TextType;color?: TextColor;
}
